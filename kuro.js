...
console.log(chalk.bold.greenBright(` Wong conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(` Error al iniciar Kuro: `, error))
}
})();
...
const directories = ['./YukiSession/', './WongJadiBot/']
