...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let gifUrl = "https://qu.ax/ZLWcO.mp4";
await conn.sendMessage(m.chat, {video: {url: gifUrl}, gifPlayback: true, caption: text.trim(), mentions: [m.sender]}, {quoted: m}), m, null, rcanal)
    await m.react('😼')
...
handler.help = ['Wong']
handler.tags = ['main']
handler.command = ['menu', 'help', 'wong', 'Wong'] 
