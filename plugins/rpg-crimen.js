...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  ...
  conn.sendMessage(m.chat, {
        text: `🚩¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} 💰 Pesetas* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} 💰 Pesetas* a ${senderName}.`,
  contextInfo: { 
  ...
  conn.reply(m.chat, `🚩 No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} 💰 Pesetas* a ${senderName}.`, m)
  break
